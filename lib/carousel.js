$(document).ready(function(){
        ...
        var images  = $('#icons img').removeClass('default').addClass('animationReady');
        var dim   = { width:images.width(),height:images.height()};

        var cnt = images.length;

        /* Finding the centers of the animation container: */
        var centerX = $('#icons').width()/2;
        var centerY = $('#icons').height()/2 - dim.height/2;

        var rotate = function(step,total){
